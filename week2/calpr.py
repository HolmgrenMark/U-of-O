...
for i in range(MONTHLEN[month]-(7-starts_weekday)):# Loop for the remainder of days in the month
	# Logic for printing one day, moving to next
	print(format(month_day, "3d"), end="")
	month_day += 1
	if i == 6 or i == 13 or i == 20 or i == 27: # index starts form 0 therefore 6,13,20,27 instead of 7,14.....
		print() # Newline at the end of each week
print() # Newline
